...
**Keep this file up to date.** Whenever you implement a feature, add a new architectural pattern, change the project structure, add dependencies, or modify commands, update the relevant sections of this file before finishing the task. This ensures CLAUDE.md always reflects the current state of the project.
